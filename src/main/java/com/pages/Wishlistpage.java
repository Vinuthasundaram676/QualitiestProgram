...
public class Wishlistpage {
   ...
   By Cart=By.xpath("//*[@id=\"blog\"]/div[3]/div[1]/div/div/div[3]/div[1]/div/div/a/i");
   By Cartverification=By.xpath("//*[@id=\"site-content\"]/div/div/article/div/div/div[1]/div/form/table/tbody/tr[1]/td[4]");
   By successmessage = By.xpath("//*[@id=\"yith-wcwl-form\"]/div[1]/div");
...
//			System.out.println("No of cols are : "+col.size());
		...
		public  List<Double> cleansePriceList(List<String> priceList){
		...
		public void addlowestPricetoCart() {
			...
			public boolean verifyitemsincart() {
				return driver.findElement(Cartverification).isDisplayed();
				
			}
			
			public String cartaddedMessage() {
